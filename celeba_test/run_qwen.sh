...
# Usage:
#   ./run_qwen.sh                                        # GPU 3, default qwen config
#   ./run_qwen.sh 0                                      # run on GPU 0
#   ./run_qwen.sh 0 --limit 50 --attributes Smiling,Male # quick subset run
#   ./run_qwen.sh 0 --demo                               # sanity-check generation only
#   ./run_qwen.sh 0 --limit 0                            # full dataset (slow)
set -euo pipefail
